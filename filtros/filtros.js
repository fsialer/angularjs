...
controladores.controller('ControladorFiltros',['$scope',function($scope){
	$scope.empleados=[
	{
	...
	salario:12000,telefono:'55818726354',bono:1.444444
	},
	{
		nombre:'Alejandro', paterno:'Mena', materno:'Morales', primerDia:new Date(),
		salario:12000,telefono:'5512312312',bono:12.989898
	}
